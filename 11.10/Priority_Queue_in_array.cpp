//Priority_Queue_in_array project_Experiment4. 
//Created by Yule, Nov_8_2015
//============================================================================== 
#include<iostream>
using namespace std;

#define MAXQSIZE 5		// Define the space size of the queue.
...
class bqueue
{
	public:
		...
		// Let user choose priority, max order or min order. 
		void maxpop();				
		void minpop();
		void maxfront();
		void minfront();
